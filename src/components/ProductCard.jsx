    ...
    <article className="product-card premium-product-card">
      ...
      <div className="product-body">
        ...
        {showCountdown ? (
          ...
          <div className="card-countdown-v31 card-countdown-placeholder-v41" aria-hidden="true">&nbsp;</div>
        )}
        ...
        {savingStats.saveMax > 0 ? (
          <div className="saving-line-v38"><span>Tiết kiệm tối đa</span><b>{formatCurrency(savingStats.saveMax, currency)}</b></div>
        ) : (
          <div className="saving-line-v38 saving-line-placeholder-v40" aria-hidden="true">&nbsp;</div>
        )}
        <button className="primary full card-compare-button-v40" onClick={() => onOpenProduct(product)}>So sánh tổng chi phí</button>
      </div>
